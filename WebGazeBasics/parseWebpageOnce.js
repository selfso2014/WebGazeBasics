...
function drawLine(x, y, w, h, size) {
    ...
    drawCrossLine(x,   y,   size)
    drawCrossLine(x+w, y,   size)
    drawCrossLine(x+w, y+h, size)
    drawCrossLine(x,   y+h, size)
    
}


/* unit drawCrossLine */
function drawCrossLine(x, y, size) {
